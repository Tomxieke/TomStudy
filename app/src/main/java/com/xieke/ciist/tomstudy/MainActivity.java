package com.xieke.ciist.tomstudy;
...
import com.xieke.ciist.tomstudy.function.ExplosionFieldActivity;
import com.xieke.ciist.tomstudy.function.ShotSrceenActivity;
import com.xieke.ciist.tomstudy.function.BubbleExplosion;
import com.xieke.ciist.tomstudy.wiget.WigetActivity;
...
public class MainActivity extends ListActivity {
    ...
    protected List<Map<String, Object>> getData() { // 封装添加资源方法
        ...
        addItem(data, "控件", WigetActivity.class); //
        addItem(data, "屏幕截图", ShotSrceenActivity.class); // 屏幕截图
        addItem(data, "爆炸效果", BubbleExplosion.class);
        addItem(data, "爆炸效果2", ExplosionFieldActivity.class);
